-- Ensures institute RPCs exist and prompts PostgREST to reload its schema cache.
-- Fixes: "Could not find the function public.superadmin_list_institutes without parameters in the schema cache"
