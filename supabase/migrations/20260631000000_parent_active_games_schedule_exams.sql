-- Parent dashboard: list in-progress games schedule exams for linked students.
...
BEGIN
  ...
  FOR v_attempt_id IN
    ...
    INNER JOIN public.parent_student_links l ON l.student_user_id = a.student_user_id
...
REVOKE ALL ON FUNCTION public.parent_list_active_games_schedule_exams() FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.parent_list_active_games_schedule_exams() TO authenticated;
